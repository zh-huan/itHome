    ...
    <div>
        ...
        <div class="header">
            <ul class="header_type">
                <li class="header_type-item" v-for="typeItem in types" :class="{'selected': typeSelected==typeItem.name}" @click="typeClick(typeItem)">{{typeItem.name}}</li>
            </ul>
